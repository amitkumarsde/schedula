...
- **See the dashboard.** `/dashboard` shows your numbers (today's doctors, upcoming, completed, total) and a calendar of your appointments coloured by status.
- **See appointments.** `/appointments` has **All, Upcoming, Completed, Missed and Cancelled** tabs, grouped by date. The detail page shows the doctor and lets you cancel an upcoming visit.
